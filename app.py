...
app = Flask(__name__)
model = joblib.load(r"C:\Users\LENOVO\Naresh IT\May\Grade Anticipation Analysis\Student Mark Predictor Project Deployment\pickle\student_mark_predictor.pkl")
